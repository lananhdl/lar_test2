        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
                ...
                {{ csrf_field() }};
                    ...
                    <div class="form-group">
                        <input type="email" name="email" id="email" class="form-control input-lg" placeholder="Vui lòng nhập địa chỉ Email" tabindex="3" required>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <textarea name="txtIntro" class="form-control input-lg tinymce" rows="4" tabindex="4"></textarea>
                            </div>
                        </div>
                    </div>
