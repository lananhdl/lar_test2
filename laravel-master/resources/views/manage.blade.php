...
<body>
    ...
    <div class="container">
        ...
        <td>{{$loop->iteration}}</td>
            <td>
                <iframe width="150" height="100" name="linktxt" src="{{$item["linkvideo"]}}" frameborder="0" allowfullscreen></iframe>
                            </td>
         <td name="nametxt">{{$item["namevideo"]}}</td>
         <td name="tacgiatxt">{{$item["author"]}}</td>
                            <td><a href="">Ẩn</a></td>
